...
//将NodeList对象转换为数组
var arrayOfNodes = Array.prototype.slice.call(someNode.childNodes, 0); //IE8除外
...
var images = document.getElementsByTagName("img"); //返回HTMLCollection对象，也是一个“动态”集合
images.length;
images[0].src;
images.item(0).src;
...
var items = ul.getElementsByTagName("li");  //会返回所有后代元素
